...
def render_battle_results():
    ...
    if st.session_state.battle_log:
        ...
        with chart_col:
            ...
            fig_hp = px.line(
                hp_df, x="Round", y="HP", color="Pokemon",
                markers=True, title="HP Drainage Over Time",
                color_discrete_map={
                    pkmn1["name"].capitalize(): "#3296ff",
                    pkmn2["name"].capitalize(): "#ff4b4b"
                }
            )
            ...
            st.plotly_chart(fig_hp, use_container_width=True)
                ...
                # Force newline for stats to ensure they fall onto the "grey" styled line (::first-line targets only the first line)
